...
void loop() {
  ...
  // delay(500);
  // Check if button is pressed and menu is switched
  ...
  switch (menuSelection) {
    ...
    case 1:
      display.fillRect(0, 17, 128, 16, SSD1306_INVERSE);
    case 2:
      display.fillRect(0, 34, 128, 16, SSD1306_INVERSE);
  }
